...
import { ArrowLeft, Calendar, Clock, CreditCard, Mail, Phone, User, Info, CheckCircle2, ShieldCheck, Ticket } from "lucide-react"
...
export default function BookingConfirmation() {
  ...
  const [payFullAmount, setPayFullAmount] = useState(false) // Toggle state
  ...
  // -- CALCULATIONS --
  // We trust the price passed from the previous step, but re-calculate if needed
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* 2. Payment Selection (The fix for the ugly checkbox) */}
            {isDepositEligible && (
              <Card className="border-0 shadow-sm">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-lg">
