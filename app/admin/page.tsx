...
export default function AdminDashboard() {
  ...
  // 2. TOGGLE STATUS (Mark Paid In-Store)
  ...
  const stats = useMemo(() => {
    ...
    // Occupancy: 3 Bays * 12 Hours = 36 Slots
